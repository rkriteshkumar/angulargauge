d3 = function() {
    ...
    function Ke(n) {
        ...
        for (var c = i; c.circle && ua(e - c.circle.x) < ka && ua(r - c.circle.cy) < ka; )
            i = c.P, a.unshift(c), Ge(c), c = i;
        a.unshift(c), ar(c);
        for (var s = o; s.circle && ua(e - s.circle.x) < ka && ua(r - s.circle.cy) < ka; )
            o = s.N, a.push(s), Ge(s), s = o;
        a.push(s), ar(s);
        var l, f = a.length;
        for (l = 1; f > l; ++l)
            s = a[l], c = a[l - 1], gr(s.edge, c.site, s.site, u);
        c = a[0], s = a[f - 1], s.edge = fr(c.site, s.site, null, u), or(c), or(s)
    }
    function Qe(n) {
        for (var t, e, r, u, i = n.x, o = n.y, a = Zc._; a; )
            if (r = nr(a, o) - i, r > ka)
                a = a.L;
            else {
                if (u = i - tr(a, o), !(u > ka)) {
        ...
        if (Zc.insert(t, c), t || e) {
            if (t === e)
                return ar(t), e = Je(t.site), Zc.insert(c, e), c.edge = e.edge = fr(t.site, c.site), or(t), or(e), void 0;
            if (!e)
                return c.edge = fr(t.site, c.site), void 0;
            ar(t), ar(e);
    ...
    function rr(n) {
        for (var t, e, r, u, i, o, a, c, s, l, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Ic, d = v.length; d--; )
            if (i = v[d], i && i.prepare())
                for (a = i.edges, c = a.length, o = 0; c > o; )
                    l = a[o].end(), r = l.x, u = l.y, s = a[++o % c].start(), t = s.x, e = s.y, (ua(r - t) > ka || ua(u - e) > ka) && (a.splice(o, 0, new pr(hr(i.site, l, ua(r - f) < ka && p - u > ka ? {x: f, y: ua(t - f) < ka ? e : p} : ua(u - p) < ka && h - r > ka ? {x: ua(e - p) < ka ? t : h, y: p} : ua(r - h) < ka && u - g > ka ? {x: h, y: ua(t - h) < ka ? e : g} : ua(u - g) < ka && r - f > ka ? {x: ua(e - g) < ka ? t : f, y: g} : null), i.site, null)), ++c)
    }
    function ur(n, t) {
    ...
    function cr(n) {
        for (var t, e = Yc, r = re(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--; )
            t = e[u], (!sr(t, n) || !r(t) || ua(t.a.x - t.b.x) < ka && ua(t.a.y - t.b.y) < ka) && (t.a = t.b = null, e.splice(u, 1))
    }
    function sr(n, t) {
        var e = n.b;
        if (e)
    ...
    function Mr(n, t) {
        ...
        for (Yc = [], Ic = new Array(n.length), Zc = new vr, Xc = new vr; ; )
            if (u = Vc, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))
                (i.x !== e || i.y !== r) && (Ic[i.i] = new er(i), Qe(i), e = i.x, r = i.y), i = n.pop();
            else {
                if (!u)
                    break;
                Ke(u.arc)
    ...
    function Lr(n, t) {
        ...
        for (n += "", t += "", Jc.lastIndex = 0, r = 0; e = Jc.exec(t); ++r)
            e.index && s.push(t.substring(a, c = e.index)), l.push({i: s.length, x: e[0]}), s.push(null), a = Jc.lastIndex;
        for (a < t.length && s.push(t.substring(a)), r = 0, i = l.length; (e = Jc.exec(n)) && i > r; ++r)
            if (o = l[r], o.x == e[0]) {
                if (o.i)
                    if (null == s[o.i + 1])
                ...
                o.x = Nr(parseFloat(e[0]), parseFloat(o.x));
        for (; i > r; )
    ...
    function ru(n) {
        for (var t = n.source, e = n.target, r = iu(t, e), u = [t]; t !== r; )
            t = t.parent, u.push(t);
    ...
    function iu(n, t) {
        if (n === t)
            return n;
        for (var e = uu(n), r = uu(t), u = e.pop(), i = r.pop(), o = null; u === i; )
            o = u, u = e.pop(), i = r.pop();
        return o
    }
    function ou(n) {
    ...
    function lu(n, t, e) {
        ...
        if (n.charge = 0, !n.leaf)
            for (var i, o = n.nodes, a = o.length, c = -1; ++c < a; )
                i = o[c], null != i && (lu(i, t, e), n.charge += i.charge, r += i.charge * i.cx, u += i.charge * i.cy);
        if (n.point) {
    ...
    function Yu(n) {
        ...
        if ((e = n.children) && (s = e.length)) {
            ...
            if (e.forEach(Iu), r = e[0], r.x = -r.r, r.y = 0, t(r), s > 1 && (u = e[1], u.x = u.r, u.y = 0, t(u), s > 2))
                for (i = e[2], Xu(r, u, i), t(i), Hu(r, i), r._pack_prev = i, Hu(i, u), u = r._pack_next, o = 3; s > o; o++) {
                    Xu(r, u, i = e[o]);
                    var p = 0, v = 1, d = 1;
                    ...
                    if (1 == p)
                        for (c = r._pack_prev; c !== a._pack_prev && !Ou(c, i); c = c._pack_prev, d++)
                            ;
    ...
    function Ri(n) {
        ...
        for (n.push(n[e - 1]); ++t <= e; )
            r = n[t], o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Hi(c, o, a);
    ...
    function Di(n) {
        ...
        for (e.push(ji(ys, i) + "," + ji(ys, o)), --r; ++r < u; )
            t = n[r], i.shift(), i.push(t[0]), o.shift(), o.push(t[1]), Hi(e, i, o);
        return e.join("")
    }
    function Pi(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4; )
            e = n[r % u], o.push(e[0]), a.push(e[1]);
        for (t = [ji(ys, o), ",", ji(ys, a)], --r; ++r < i; )
            e = n[r % u], o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), Hi(t, o, a);
        return t.join("")
    }
    function Ui(n, t) {
        var e = n.length - 1;
    ...
    function Oi(n) {
        for (var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = r[0] = Fi(u, i); ++t < e; )
            r[t] = (o + (o = Fi(u = i, i = n[t + 1]))) / 2;
        return r[t] = o, r
    }
    function Yi(n) {
        for (var t, e, r, u, i = [], o = Oi(n), a = -1, c = n.length - 1; ++a < c; )
            t = Fi(n[a], n[a + 1]), ua(t) < ka ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, u > 9 && (u = 3 * t / Math.sqrt(u), o[a] = u * e, o[a + 1] = u * r));
        for (a = - 1; ++a <= c; )
    ...
    function Zi(n) {
        for (var t, e, r, u = -1, i = n.length; ++u < i; )
            t = n[u], e = t[0], r = t[1] + gs, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
        return n
    }
    function Vi(n) {
        function t(t) {
    ...
    Zo.geo.transform = function(n) {
        ...
        return n.area = function(n) {
            ...
            return Nc = Lc = -(Ac = Cc = 1 / 0), Zo.geo.stream(n, u(qc)), [[Ac, Cc], [Nc, Lc]]
    ...
    (Zo.geo.stereographic = function() {
        ...
        function t(n) {
            ...
            for (p = M.length; y > o; ++o)
                if (!(x[o].index < 0)) {
                    for (; !Ve(M[p - 2], M[p - 1], x[o].index, t); )
                        --p;
                    M[p++] = x[o].index
                }
            var b = [];
    ...
    Oc.area = function() {
        ...
        for (var t, e, r, u, i, o, a = Be(n), c = -1, s = this.length - Be(this), l = this[s - 1]; ++c < s; ) {
            for (t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - a) - 1], e = - 1; ++e < r; )
                o = t[e], Xe(o, l, u) ? (Xe(i, l, u) || n.push($e(i, o, l, u)), n.push(o)) : Xe(i, l, u) && n.push($e(i, o, l, u)), i = o;
            a && n.push(n[0]), l = u
        }
        return n
    };
    ...
    er.prototype.prepare = function() {
        ...
        return t.sort(ur), t.length
            ...
            if (n) {
                ...
                this._ ? (n = xr(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, this._ = t, e = null);
            for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; )
                r = e.U, e === r.L ? (u = r.R, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.R && (mr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, yr(this, r))) : (u = r.L, u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.L && (yr(this, e), n = e, e = n.U), e.C = !1, r.C = !0, mr(this, r))), e = n.U;
            this._.C = !1
        }, remove: function(n) {
        ...
        return n ? t(n) : (t.links = function(n) {
            ...
            return Mr(e(n)).cells.forEach(function(e, r) {
                for (var u, i, o = e.site, a = e.edges.sort(ur), c = -1, s = a.length, l = a[s - 1].edge, f = l.l === o ? l.r : l.l; ++c < s; )
                    u = l, i = f, l = a[c].edge, f = l.l === o ? l.r : l.l, r < i.i && r < f.i && br(o, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]])
            }), t
        }, t.x = function(n) {
            ...
            return arguments.length ? t.clipExtent(n && [[0, 0], n]) : a === Wc ? null : a && a[1]
        }, t)
    };
    var Wc = [[-1e6, -1e6], [1e6, 1e6]];
    ...
    Zo.interpolateTransform = nu, Zo.layout = {}, Zo.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            if (g)
                for (lu(t = Zo.geom.quadtree(d), r, o), e = - 1; ++e < _; )
    ...
    Zo.layout.histogram = function() {
        ...
        function n(n, i) {
            ...
            function c(n, t, r) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], s = i._tree.mod, l = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = Nu(a), i = Cu(i), a && i; )
                        c = Cu(c), o = Nu(o), o._tree.ancestor = n, u = a._tree.prelim + f - i._tree.prelim - s + e(a, i), u > 0 && (Pu(Uu(a, n, r), n, u), s += u, l += u), f += a._tree.mod, s += i._tree.mod, h += c._tree.mod, l += o._tree.mod;
    ...
    var Cs = {n: "ns-resize", e: "ew-resize", s: "ns-resize", w: "ew-resize", nw: "nwse-resize", ne: "nesw-resize", se: "nwse-resize", sw: "nesw-resize"}, Ns = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Ls = Zo.time = {}, Ts = Date, qs = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    ...
    var el = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], rl = [[Ls.second, 1], [Ls.second, 5], [Ls.second, 15], [Ls.second, 30], [Ls.minute, 1], [Ls.minute, 5], [Ls.minute, 15], [Ls.minute, 30], [Ls.hour, 1], [Ls.hour, 3], [Ls.hour, 6], [Ls.hour, 12], [Ls.day, 1], [Ls.day, 2], [Ls.week, 1], [Ls.month, 1], [Ls.month, 3], [Ls.year, 1]], ul = [[ao("%Y"), Zt], [ao("%B"), function(n) {
                return n.getMonth()
            }], [ao("%b %d"), function(n) {
                return 1 != n.getDate()
            }], [ao("%a %d"), function(n) {
